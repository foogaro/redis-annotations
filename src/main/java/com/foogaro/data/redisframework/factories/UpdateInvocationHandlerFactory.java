...
public class UpdateInvocationHandlerFactory {
    ...
    public static InvocationHandler get(String dataStoreOperationName, String dataStoreCommand) throws Throwable {
        ...
        switch (dataType) {
            case JSON:
                return new com.foogaro.data.redisframework.handlers.json.UpdateInvocationHandler();
            case HASH:
                return new com.foogaro.data.redisframework.handlers.hash.UpdateInvocationHandler();
            default:
